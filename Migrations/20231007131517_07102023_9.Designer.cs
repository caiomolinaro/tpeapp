...
namespace tpeapp.Migrations
{
    ...
    [Migration("20231007131517_07102023_9")]
    partial class _07102023_9
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("tpeapp.Models.SchedulesModel", b =>
                {
                    ...
                    b.Property<int?>("WeekDaysModelWeekDayId")
                        .HasColumnType("int");

                    b.HasKey("SchedulesId");

                    b.HasIndex("SchedulesId1");

                    b.HasIndex("WeekDaysModelWeekDayId");
            ...
            modelBuilder.Entity("tpeapp.Models.SchedulesModel", b =>
                {
                    b.HasOne("tpeapp.Models.SchedulesModel", "Schedules")
                        .WithMany()
                        .HasForeignKey("SchedulesId1");

                    b.HasOne("tpeapp.Models.WeekDaysModel", null)
                        .WithMany("Schedules")
                        .HasForeignKey("WeekDaysModelWeekDayId");
